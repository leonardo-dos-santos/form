...
firstname.addEventListener("input", function () {
  if (firstname.value === '') {
    firstnameError.textContent = 'Please type in your firstname.';
  } else {
...
email.addEventListener("input", function () {
  if (email.validity.typeMismatch) {
    emailError.textContent = 'Please enter in a valid Email. e(johnSmith@email.com)';
  } else {
...
tel.addEventListener("input", function () {
  if (tel.validity.patternMismatch) {
    telError.textContent = 'Please enter in a 10 digit phonenumber';
  } else {
